...
<div
  className="hidden md:block w-1/2 bg-cover bg-center relative h-full"
>
  <div className="absolute inset-0 bg-gradient-to-br from-blue-600/40 to-purple-700/40 animate-pulse"></div>
</div>


      {/* Right side full background */}
      <div className="flex items-center justify-center w-full md:w-1/2 bg-gray-50" />
